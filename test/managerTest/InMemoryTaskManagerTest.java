...
public class InMemoryTaskManagerTest {
    ...
    void shouldAddNewTask() {
        ...
        assertEquals(taskNewId, tasks.getFirst(), "Задачи не совпадают.");
    }
    ...
    void shouldAddNewEpicAndItsSubtask() {
        ...
        assertEquals(epicNewId, epics.getFirst(), "Эпики не совпадают.");
        ...
        assertEquals(subtaskNewId, subtasks.getFirst(), "Подзадачи не совпадают.");

        ArrayList<Integer> listSubtaskEpic = epic.getListSubtaskEpic();
        int idSubtaskInEpic = listSubtaskEpic.getFirst();
    ...
    void shouldFullDeletedEpic() {
        ...
        if (listIdNumberSubtasksInEpic != null && listIdNumberSubtasksInEpic.getFirst() == subtask.getId() &&
